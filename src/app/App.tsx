...
type ScreenState =
  | "ambient"
  | "ambient-info"
  | "ambient-ticket-active"
  | "ambient-ticket-resolved"
  | "action"
  | "recovery"
  | "escalate"
  | "confirmation"
...
export default function App() {
  const [currentScreen, setCurrentScreen] =
    useState<ScreenState>("ambient");
  const [currentTime, setCurrentTime] = useState(new Date());
  const [optionalNote, setOptionalNote] = useState("");
  const [ticketId] = useState("AQ-203");
  const [ticketStatus, setTicketStatus] =
    useState<TicketStatus>(null);
  const [airQualityLevel, setAirQualityLevel] =
    useState<AirQualityLevel>("buona");
  ...
  return (
    ...
    >
        ...
        <AnimatePresence mode="wait">
          {currentScreen === "ambient" && (
            <AmbientStatus
              ...
              onViewSummary={() =>
                setCurrentScreen("summary-classroom")
              }
          ...
          {currentScreen === "ambient-ticket-active" && (
            <AmbientWithTicket
              ...
              onCycle={cycleAmbientScreens}
              onViewSummary={() =>
                setCurrentScreen("summary-office")
              }
            />
          )}
          {currentScreen === "ambient-ticket-resolved" && (
          ...
          {currentScreen === "co-alert" && (
            <COAlertScreen
              key="co-alert"
              currentTime={formatTime(currentTime)}
              onProceed={() => setCurrentScreen("co-action")}
            />
          )}
          {currentScreen === "co-action" && (
            <COActionScreen
              key="co-action"
              currentTime={formatTime(currentTime)}
            />
      ...
      <div className="fixed left-4 top-1/2 -translate-y-1/2 flex flex-col gap-2 px-2 py-3 rounded-2xl bg-black/70 backdrop-blur-sm z-50">
        <NavButton
          active={currentScreen.startsWith("ambient")}
          onClick={() => setCurrentScreen("ambient")}
        >
          A
        </NavButton>
        <NavButton
          active={currentScreen === "action"}
          onClick={() => setCurrentScreen("action")}
        >
          !
        </NavButton>
        <NavButton
          active={currentScreen === "recovery"}
          onClick={() => setCurrentScreen("recovery")}
        >
          R
        </NavButton>
        <NavButton
          active={currentScreen === "escalate"}
          onClick={() => setCurrentScreen("escalate")}
        >
          E
        </NavButton>
        <NavButton
        ...
        <NavButton
          active={currentScreen.startsWith("summary")}
          onClick={() => setCurrentScreen("summary-classroom")}
        >
          S
        </NavButton>
        <div className="w-full h-px bg-white/20 my-1" />
        <NavButton
          active={currentScreen === "co-alert"}
          onClick={() => setCurrentScreen("co-alert")}
        >
          C!
        </NavButton>
        {/* <NavButton active={currentScreen === 'co-action'} onClick={() => setCurrentScreen('co-action')}>
          C✓
        </NavButton> */}
      </div>
    </div>
...
function AmbientStatus({
    ...
    switch (airQualityLevel) {
      ...
      case "pessima":
        return {
          ...
          description:
            "Situazione critica - evacuare la stanza",
          co2: "2200",
  ...
  return (
    ...
    >
      <Header
        room="Aula 2B"
        location="Piano 2, Edificio A"
        time={currentTime}
        onRoomClick={onCycle}
        onSummaryClick={onViewSummary}
      />
      ...
      >
        <div className="relative">
          <motion.div
            ...
            className="mb-10"
          >
            {levelData.avatarType === "relaxed" && (
              <AvatarRelaxed color={levelData.color} />
            )}
            {levelData.avatarType === "neutral" && (
              <AvatarNeutral color={levelData.color} />
            )}
            {levelData.avatarType === "concerned" && (
              <AvatarConcerned color={levelData.color} />
            )}
          </motion.div>
          <IconBubble
            icon={levelData.icon}
      ...
      >
        <MetricCard
          ...
          unit="ppm"
          status={
            airQualityLevel === "buona" ||
            airQualityLevel === "accettabile"
              ? "good"
              : "warning"
          }
        />
...
function AmbientInfoLayer({
  currentTime,
  onTransition,
  onCycle,
  onViewSummary,
}: AmbientInfoLayerProps) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                >
                  Una buona ventilazione aiuta attenzione e
                  comfort
                </p>
              </div>
            </div>
    ...
    >
      ...
      >
        <div className="relative">
          ...
          <ChatBubble
            text={isResolved ? "Tutto risolto!" : "Aria buona!"}
            delay={0.8}
            side="right"
          />
        </div>
        ...
        >
          ...
          >
            <div className="flex items-start gap-3">
              ...
              >
                Ventilare presto ha aiutato a riportare la
                stanza nei valori corretti
              </p>
            </div>
          </div>
        </motion.div>
    ...
    >
      ...
      >
        <div className="relative">
          ...
          <ChatBubble
            text="Dai, sta migliorando!"
            delay={0.8}
            side="left"
          />
          {windowsOpened && (
            <ChatBubble
              text="Ti ricorderò di chiudere le finestre tra 10 minuti"
              delay={1.2}
              side="right"
            />
          )}
    ...
    >
      ...
      >
        ...
        >
          ...
          <InfoField
            label="Stato attuale"
            value="Non migliora dopo ventilazione"
          />
        </motion.div>
...
function AirQualityLegend({
  ...
  currentLevel: AirQualityLevel;
  onLevelClick: (level: AirQualityLevel) => void;
}) {
  const levels: Array<{
    key: AirQualityLevel;
    label: string;
            ...
            <button
              ...
              style={{
                ...
                border: isActive
                  ...
                  : `2px solid ${level.color}33`,
                boxShadow: isActive
                  ? `0 0 0 3px ${level.color}22`
                  : "none",
              }}
            >
              <div
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: level.color,
                    boxShadow: isActive
                      ? `0 8px 24px ${level.color}60`
                      : `0 4px 12px ${level.color}30`,
                    border: isActive
                      ? "3px solid white"
                      : "none",
                  }}
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 8px 32px rgba(8, 145, 178, 0.3), inset 0 -4px 12px rgba(0, 0, 0, 0.1)",
        }}
      >
        <div className="flex gap-12 mb-3">
          <div
...
function COAlertScreen({
  ...
  const CO_RED = "#dc2626";
  const CO_RED_SOFT = "rgba(220, 38, 38, 0.12)";
  const CO_RED_BORDER = "rgba(220, 38, 38, 0.35)";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            ...
            style={{
              background: `linear-gradient(135deg, ${CO_RED} 0%, #b91c1c 100%)`,
        ...
        >
          CO is invisible and dangerous — do not stay in this
          room.
        </motion.p>
        ...
        <motion.div
          ...
          animate={{ scale: 1, opacity: 1 }}
          transition={{ delay: 0.7, duration: 0.5 }}
          className="w-full max-w-xl px-8 py-6 rounded-3xl mb-5"
          style={{
            background: CO_RED_SOFT,
            border: `3px solid ${CO_RED_BORDER}`,
          }}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-baseline gap-2">
        ...
        >
          ...
          >
            Building manager has been automatically notified.
          </p>
        </motion.div>
      </motion.div>

      {/* Prototype navigation — no occupant self-resolution action */}
      <motion.div
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ delay: 1.0, duration: 0.6 }}
      ...
      >
        <button
          className="px-8 py-3 rounded-xl transition-all duration-300 hover:opacity-80"
          style={{
            fontFamily: "var(--font-body)",
            fontSize: "0.875rem",
            fontWeight: 600,
          ...
          onClick={onProceed}
        >
          → Prototype: view evacuated state
        </button>
      </motion.div>
    </motion.div>
  );
...
function COActionScreen({
  currentTime,
}: {
  currentTime: string;
}) {
  const CO_RED = "#dc2626";
  const CO_RED_SOFT = "rgba(220, 38, 38, 0.1)";
  const CO_RED_BORDER = "rgba(220, 38, 38, 0.3)";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow: "0 12px 40px rgba(127, 29, 29, 0.4)",
            }}
          >
            <ShieldOff
              size={68}
        ...
        >
          CO detected at 10:42 — do not re-enter
        </motion.p>

        {/* Status cards — no sparkline, no trend */}
        <motion.div
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.7, duration: 0.6 }}
        ...
        >
          ...
          <div
            ...
            style={{
              background: CO_RED_SOFT,
              border: `2px solid ${CO_RED_BORDER}`,
              backdropFilter: "blur(8px)",
            }}
          >
            <CheckCircle
          ...
          >
            ...
            <div>
              ...
              >
                Do not re-enter until cleared by building
                management
              </div>
            </div>
          </div>
      ...
      >
        ...
        >
          Informational display — no action required from
          occupants
        </div>
      </motion.div>
    </motion.div>
...
function MetricCardCompact({
  ...
  const color =
    status === "improving" ? "#0891b2" : "var(--aq-ok-primary)";
  return (
    <div
